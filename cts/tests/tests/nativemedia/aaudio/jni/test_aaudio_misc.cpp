...
#define ENUM_CANNOT_CHANGE "enum in API cannot change"
    ...
    static_assert(1000 == AAUDIO_SYSTEM_USAGE_EMERGENCY, ENUM_CANNOT_CHANGE);
    static_assert(1001 == AAUDIO_SYSTEM_USAGE_SAFETY, ENUM_CANNOT_CHANGE);
    static_assert(1002 == AAUDIO_SYSTEM_USAGE_VEHICLE_STATUS, ENUM_CANNOT_CHANGE);
    static_assert(1003 == AAUDIO_SYSTEM_USAGE_ANNOUNCEMENT, ENUM_CANNOT_CHANGE);
