...
class AppOpsForegroundControlForegroundService : Service() {
    companion object {
        private val lock = ReentrantLock()
        private val condition = lock.newCondition()

        private var instance: AppOpsForegroundControlForegroundService? = null
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        startForeground(2, Notification.Builder(this, NOTIFICATION_CHANNEL_ID)
                ...
                .setContentTitle("Foreground service").build())
