...
public class SimpleContentSuggestionsService extends ContentSuggestionsService {

    private static final String TAG = SimpleContentSuggestionsService.class.getSimpleName();
