...
public class DensityListPreference extends RestrictedListPreference {
    private static final String TAG = "DensityListPreference";
    private EnforcedAdmin mAdmin;
    private final CharSequence[] mInitialEntries;
    private final CharSequence[] mInitialValues;

    public DensityListPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
