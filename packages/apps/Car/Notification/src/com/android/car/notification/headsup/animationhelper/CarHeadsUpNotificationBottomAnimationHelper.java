...
/**
 * Sample AnimationHelper that animates the notification fading in from the bottom of the screen.
 */
public class CarHeadsUpNotificationBottomAnimationHelper implements
