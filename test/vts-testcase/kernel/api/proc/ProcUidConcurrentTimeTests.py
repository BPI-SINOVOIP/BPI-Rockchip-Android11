...
class ProcUidConcurrentActiveTimeTest(KernelProcFileTestBase.KernelProcFileTestBase):
...
class ProcUidConcurrentPolicyTimeTest(KernelProcFileTestBase.KernelProcFileTestBase):
