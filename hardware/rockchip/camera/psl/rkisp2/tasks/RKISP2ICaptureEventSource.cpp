...
#define LOG_TAG "RKISP2ICaptureEventSource"

#include "RKISP2ICaptureEventSource.h"
#include "LogHelper.h"
 ...
 */
status_t
RKISP2ICaptureEventSource::attachListener(ICaptureEventListener *observer)
{
 ...
 */
void
RKISP2ICaptureEventSource::cleanListener()
{
    LOGD("@%s", __FUNCTION__);
...
status_t
RKISP2ICaptureEventSource::notifyListeners(ICaptureEventListener::CaptureMessage *msg)
{
    LOGD("@%s", __FUNCTION__);
    bool ret = false;
    std::lock_guard<std::mutex> l(mListenerLock);
