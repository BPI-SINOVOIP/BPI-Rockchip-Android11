...
#include "RKISP2JpegEncodeTask.h"
#include "LogHelper.h"
#include "RKISP2ProcUnitSettings.h"
#include "CameraStream.h"
#include "PlatformData.h"
#include "RKISP2CameraHw.h" // PartialResultEnum
...
RKISP2JpegEncodeTask::RKISP2JpegEncodeTask(int cameraId):
    mImgEncoder(nullptr),
    mJpegMaker(nullptr),
    mCameraId(cameraId)
{
...
RKISP2JpegEncodeTask::~RKISP2JpegEncodeTask()
{
    HAL_TRACE_CALL(CAM_GLBL_DBG_HIGH);
...
status_t RKISP2JpegEncodeTask::handleMessageSettings(RKISP2ProcUnitSettings &procSettings)
{
    Camera3Request *req = procSettings.request;
    std::shared_ptr<RKISP2CaptureUnitSettings> capSettings = procSettings.captureSettings;
 ...
 */
void RKISP2JpegEncodeTask::readExifInfoFromAndroidResult(const CameraMetadata &result,
...
status_t
RKISP2JpegEncodeTask::handleMessageNewJpegInput( RKISP2ITaskEventListener::PUTaskEvent &msg)
{
    HAL_TRACE_CALL(CAM_GLBL_DBG_HIGH);
    status_t status = NO_ERROR;
 ...
 */
AwbMode RKISP2JpegEncodeTask::convertAwbMode(const uint8_t androidAwb) const
{
    HAL_TRACE_CALL(CAM_GLBL_DBG_HIGH);
 ...
 */
status_t
RKISP2JpegEncodeTask::handleISPData(ExifMetaData& exifData) const
{
...
status_t RKISP2JpegEncodeTask::handleExposureData(ExifMetaData& exifData,
...
status_t RKISP2JpegEncodeTask::handleIa3ASetting(ExifMetaData& exifData,
                                           const ExifDataCache &exifCache) const
{
...
status_t RKISP2JpegEncodeTask::handleFlashData(ExifMetaData& exifData,
                                         const ExifDataCache &exifCache) const
{
...
status_t RKISP2JpegEncodeTask::handleMakernote(ExifMetaData& exifData,
                                         ExifDataCache &exifCache) const
{
    status_t status = OK;
...
status_t RKISP2JpegEncodeTask::handleJpegSettings(ExifMetaData& exifData,
                                            RKISP2JpegEncodeTask::ExifDataCache &exifCache) const
{
